...
def main():
    ...
    scatter_plot(v_band_weekly_bins,plot_name="aavso_vband_1_week_bins_scatter", plot_title="AAVSO 1 week v-band bins, air mass <= 2, bin uncertainty < .001",marker_size=16)
